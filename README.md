...
[*-----------Deprecated----------------*]
- Spinner Is Deprecated
----------------------------------
[*-------------Edited----------------*]
- _scaling.scss File

### What Is Contains In SASS Files?:
- _colors.scss: Contains 22 Color With Levels, For See This Colors Open 'src/SASS/_colors.scss'

- _theme.scss : For See This Themes Open 'src/SASS/_theme.scss'
...
- _scaling.scss:
 - Scaling Looping
 - Zoom Looping *New Loop In Dev_v1.3*

- _mixins.scss:
 - Contains More Than +50 @mixin

- _functions.scss:
 - Contains More Than +20 @functions || Placeholders & @mixins
...
/* ----------------------------------------------------- */
 - All SafeArea[role="toast"] Classes Is [.right-position]
...
[*-------------SASS----------------*] /* Why This Is Easy Options? */ Becuase SASS Is Shorter Lang... & You Can Call Mixins & More
 ...
 - Elements & Classes Syntax With Mixins[@mixin]: `element {@include YOUR_MIXIN_HERE;}` Or With Classes `.element {@include YOUR_MIXIN_HERE;}`
